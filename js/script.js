...
function textDefilant(){
    var typed = new Typed('#typed', {
        strings: ["Bienvenue sur mon Portfolio numérique","Je suis Développeur Web", "Je suis Développeur d'Applications ",'<a href="https://ella-fitzgerald.ent.auvergnerhonealpes.fr/le-lycee/la-restauration/" target="_blank" class="news">Menu cantine</a>'],
        typeSpeed : 100,
        backSpeed : 50,
        delay:500,
        loop: true,
